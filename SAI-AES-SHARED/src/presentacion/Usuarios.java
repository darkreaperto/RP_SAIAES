...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuarios.findByCodUsuarios", query = "SELECT u FROM Usuarios u WHERE u.codUsuarios = :codUsuarios")
    , @NamedQuery(name = "Usuarios.findByNombreUsuarios", query = "SELECT u FROM Usuarios u WHERE u.nombreUsuarios = :nombreUsuarios")
    , @NamedQuery(name = "Usuarios.findByClaveUsuarios", query = "SELECT u FROM Usuarios u WHERE u.claveUsuarios = :claveUsuarios")
    , @NamedQuery(name = "Usuarios.findByCodRolUsuar", query = "SELECT u FROM Usuarios u WHERE u.codRolUsuar = :codRolUsuar")})
public class Usuarios implements Serializable {
    ...
    public Usuarios(Long codUsuarios) {
        this.codUsuarios = codUsuarios;
    }

    public Usuarios(Long codUsuarios, String nombreUsuarios, String claveUsuarios, long codRolUsuar) {
        this.codUsuarios = codUsuarios;
    ...
    public String toString() {
        return "presentacion.Usuarios[ codUsuarios=" + codUsuarios + " ]";
    }
